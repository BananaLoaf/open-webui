    ...
    if event_emitter:
        try:
            ...
            if (continuing and 'error' not in response_data) or (
                not continuing and choices and (content or response_output or response_data.get('response_id'))
            ):
                if content or response_output or continuing or response_data.get('response_id'):
                    if not continuing:
                        await event_emitter(
                            {
                                'type': 'chat:completion',
